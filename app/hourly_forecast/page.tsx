...
import { Clock, Thermometer, Droplets, Wind, CloudRain, Zap } from "lucide-react";
          ...
          {hourlyData.map((hour: any, index: number) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-3xl font-black mt-3 tracking-tighter">{Math.round(hour.main.temp)}°</p>
                ...
                <div className="mt-5 pt-4 border-t border-white/5 w-full">
                  <div className="flex items-center justify-center gap-1.5">
                    ...
                    <span className="text-[11px] font-black text-gray-300">{hour.main.humidity}%</span>
                  </div>
                </div>
              </div>
            );
            ...
            return (
              <div 
                ...
                className={`flex items-center justify-between p-6 md:p-8 ${
                  index !== hourlyData.length - 1 ? "border-b border-white/5" : ""
              ...
              >
                ...
                <div className="flex items-center gap-4 md:gap-10">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-black text-xl md:text-3xl tracking-tighter">
                      {Math.round(hour.main.temp)}<span className="text-sky-500">°C</span>
                    </span>
                  </div>
                </div>
                ...
                <div className="hidden lg:flex items-center gap-12">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-sm font-bold text-gray-200">{Math.round(hour.wind.speed)} km/h</span>
                  </div>
                  
                  <div className="flex flex-col items-center">
                    <div className="flex items-center gap-2 text-gray-400 mb-1">
                      <Thermometer size={16} className="text-orange-400" />
                      <span className="text-[10px] font-black uppercase tracking-widest">Feels</span>
                    </div>
                    <span className="text-sm font-bold text-gray-200">{Math.round(hour.main.feels_like)}°</span>
                  </div>
                </div>
